...
@section('content')
	...
	{{-- Create User Form --}}
	<form class="form-horizontal" method="post" action="@if (isset($user)){{ URL::to('admin/users/' . $user->id . '/edit') }}@endif" autocomplete="off" enctype="multipart/form-data">
		<!-- CSRF Token -->
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="tab-general">
				...
				<!-- Image Upload -->
				<div class="form-group {{{ $errors->has('img_path') ? 'error' : ''}}}">
					<div class="col-md-12">
						<label class="col-md-2 control-label" for="img_path">Image Upload</label>
						<div class="col-md-10">
							{{Form::file('img_path')}}
						</div>
					</div>
